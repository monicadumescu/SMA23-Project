package com.example.agentie_imobiliara.MessagingsServices;
...
public class BookingStatusMessaging extends FirebaseMessagingService {
    ...
    private void sendNotification(String messageBody) {
        ...
        String channelId = "booking_status_channel";
